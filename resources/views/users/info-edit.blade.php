            ...
            <div class="row pt-2 g-2">
                ...
                <div class="col-12 col-sm-6">
                    <input type="tel" name="tel" id="inputTel"
                        ...
                        value="{{ old('tel', $userInfo->tel) }}" maxlength="13">
                    @error('tel')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row pt-2 g-2">
                ...
                <div class="col-12 col-sm-6">
                    <input type="text" name="postal_code" id="inputPostalCode"
                        ...
                        value="{{ old('postal_code', $userInfo->postal_code) }}">
                    @error('postal_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12 col-sm-6">
                    <select class="form-select @error('pref') is-invalid @enderror" id="selectPrefecture" name="pref">
                        ...
                        @foreach ($prefectures as $prefecture)
                            <option value="{{ $prefecture }}" @if (old('pref', $userInfo->pref) == $prefecture) selected @endif>
                                {{ $prefecture }}</option>
                        @endforeach
                    </select>
                    @error('pref')
            ...
            <div class="row pt-2 g-2">
                ...
                <div class="col-12 col-sm-6">
                    <input type="text" name="building" id="inputBuilding" class="form-control" placeholder="あまあまハイツ"
                        value="{{ old('building', $userInfo->building) }}">
                    @error('building')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
