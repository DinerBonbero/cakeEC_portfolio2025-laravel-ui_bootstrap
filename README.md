...
・見やすさを意識しました。
## 反省点<br>
コミットメッセージを理解しておらず「どこの何の機能を修正したのか？」を記載せず「修正しました」と一括で作成してしまいました。
この場合直前のコミットメッセージは修正できるけど、古いコミットメッセージは修正が困難だと実感しました。
次回からコミットメッセージの入力には気を付けます。
